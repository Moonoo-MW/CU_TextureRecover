...
namespace GuiReplacer
{
    ...
    public sealed class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            ScheduleReplacementPipeline("plugin awake", Config.Instance.InitialScanDelaySeconds);
        ...
        private void OnSceneLoaded(Scene scene, LoadSceneMode mode)
        {
            ...
            ScheduleReplacementPipeline("scene loaded: " + scene.name, Config.Instance.SceneScanDelaySeconds);
        }
        ...
        public void RunReplacementPipeline()
        {
            try
            {
                ...
                if (Config.Instance.EnableVerboseLog)
                {
